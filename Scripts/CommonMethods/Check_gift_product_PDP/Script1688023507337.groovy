...
WebUI.click(findTestObject('pdp/gwpGiftDropdown_pdp'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('1vedant/PDP/gift_option2_giftdropdown_PDP'), FailureHandling.OPTIONAL)
