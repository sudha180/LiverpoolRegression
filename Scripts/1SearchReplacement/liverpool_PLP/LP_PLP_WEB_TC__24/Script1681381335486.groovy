...
WebUI.verifyElementPresent(findTestObject('1vedant/PLP/MostViewed_rightArrow'), 0)

WebUI.verifyElementPresent(findTestObject('1vedant/PLP/MostViewed_LeftArrow'), 0)

WebUI.verifyElementPresent(findTestObject('1vedant/PLP/MostViewed_Product_1_Title'), 0)
