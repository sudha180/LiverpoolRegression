...
WebUI.click(findTestObject('1vedant/PLP/Rating_SortBy_PLP'))

'verify of presence of 5 star checked\r\n'
WebUI.verifyElementPresent(findTestObject('1vedant/PLP/5starPoduct6_PLP'), 0)

'verify of presence of 4 star checked only \r\n\r\n'
WebUI.verifyElementNotPresent(findTestObject('1vedant/PLP/4starPoduct_PLP'), 0)
