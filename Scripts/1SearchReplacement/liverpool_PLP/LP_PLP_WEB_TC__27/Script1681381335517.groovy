...
productName = WebUI.getText(findTestObject('1vedant/PLP/MostViewed_Product_1_Title'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('1vedant/PLP/MostViewed_Product_1_Title'))
