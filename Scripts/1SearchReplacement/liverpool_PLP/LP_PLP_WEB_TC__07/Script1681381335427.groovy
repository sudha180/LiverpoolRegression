...
WebUI.callTestCase(findTestCase('null'), [('searchTerm') : 'mobile'], FailureHandling.STOP_ON_FAILURE)
...
'comare 2 discount price to 3 discount price'
...
'comare 1 sell price to 2sell  price'
...
'comare 2 sell price to 3sell  price'
