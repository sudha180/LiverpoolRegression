...
WebUI.verifyElementPresent(findTestObject('pdp/ShipFreeTo_pdp'), 0)

WebUI.click(findTestObject('pdp/ChangeDirection_pdp'))

WebUI.click(findTestObject('pdp/SelectStoreRadioButton_pdp'))
