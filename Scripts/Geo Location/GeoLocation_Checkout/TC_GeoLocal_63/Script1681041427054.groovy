...
WebUI.navigateToUrl(GlobalVariable.GWPProductLink)
...
WebUI.verifyElementPresent(findTestObject('pdp/GiftWithPurchase_pdp'), 0)

WebUI.scrollToElement(findTestObject('pdp/AddToCart_pdp'), 0)

WebUI.click(findTestObject('pdp/GiftWithPurchasePopup_pdp'))

WebUI.scrollToElement(findTestObject('pdp/GiftWithPurchaseButton_pdp'), 0)

WebUI.click(findTestObject('pdp/GiftWithPurchaseButton_pdp'))
