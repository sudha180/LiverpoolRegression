...
WebUI.callTestCase(findTestCase('null'), [('searchTerm') : 'Lavadoras'], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('HomePage/FirstProduct_plp'))

WebUI.verifyElementNotPresent(findTestObject('pdp/ClickNCollectLabel_pdp'), 0)
