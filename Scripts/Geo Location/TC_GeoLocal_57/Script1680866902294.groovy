...
WebUI.click(findTestObject('pdp/WishListButton_pdp'))

WebUI.click(findTestObject('CLP/AfterLogin_hp'))

WebUI.click(findTestObject('pdp/WishListHeaderButton_pdp'))
...
WebUI.verifyElementPresent(findTestObject('CLP/MoreDeliveryLink_cart'), 0)
