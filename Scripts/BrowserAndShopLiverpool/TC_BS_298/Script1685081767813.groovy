...
WebUI.verifyElementPresent(findTestObject('0PDPPage/GID collection/SoftLine_product1_quantity_PDP'), 0)

WebUI.verifyElementPresent(findTestObject('0PDPPage/GID collection/StickyBar_product2_quantity_PDP'), 0)
