...
discountpriceRange = WebUI.getText(findTestObject('1vedant/PLP/product-1-DiscountPrice_PLP'), FailureHandling.STOP_ON_FAILURE)

if (discountpriceRange.contains('-')) {
    println('show price range product')
} else {
    println('not a price range product')
}
