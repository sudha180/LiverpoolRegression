...
WebUI.click(findTestObject('Page_vaso en Liverpool/button_Ms vendido_srp'), FailureHandling.STOP_ON_FAILURE)

masVendidoUrl = WebUI.getUrl()

masVendidoUrl.contains('st=sold|1')
