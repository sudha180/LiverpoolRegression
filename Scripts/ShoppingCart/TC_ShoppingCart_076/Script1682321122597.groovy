...
WebUI.click(findTestObject('1vedant/cart/GiftWrapper_GiftType_option1'))

WebUI.verifyElementPresent(findTestObject('1vedant/cart/GiftWrapper_submit'), 0)

WebUI.setText(findTestObject('1vedant/cart/GiftWrapper_textarea'), 'gift')
