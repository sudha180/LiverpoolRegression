...
WebUI.callTestCase(findTestCase('null'), [('searchTerm') : GlobalVariable.DigitalItem], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('null'), [('SearchTerm') : GlobalVariable.DigitalItem], 
    FailureHandling.STOP_ON_FAILURE)
