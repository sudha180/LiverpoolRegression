...
WebUI.verifyElementClickable(findTestObject('1vedant/cart/product1_Name_Mybag_cart'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementClickable(findTestObject('1vedant/cart/product2_Name_Mybag_cart'), FailureHandling.STOP_ON_FAILURE)
