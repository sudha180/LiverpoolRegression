...
WebUI.verifyElementPresent(findTestObject('1vedant/cart/SaveForLater_product1_CART(BAG)'), 0)

WebUI.verifyElementNotPresent(findTestObject('1vedant/cart/SaveForLater_product2_CART(BAG)'), 0)
