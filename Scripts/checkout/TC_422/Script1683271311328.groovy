...
WebUI.verifyElementPresent(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/subTotalWithProductCount_opc'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/discountLabel_opc'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/shippingCostLabel_opc'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/totalPriceLabel_opc'), 0)

actualFont = WebUI.getCSSValue(findTestObject('DemoObjects/checkoutpage/Page_/totalPriceLabel_opc'), 'font')
...
subTotalPrice = WebUI.getText(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/subTotalPrice_opc'), FailureHandling.STOP_ON_FAILURE)

def subTotalPrice1 = CustomKeywords.'customkeywords.myKeywords.removeDollar'(subTotalPrice)

KeywordUtil.logInfo(subTotalPrice1)

DiscountPrice = WebUI.getText(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/DiscountPrice_opc'), FailureHandling.STOP_ON_FAILURE)

def DiscountPrice1 = CustomKeywords.'customkeywords.myKeywords.removeDollar'(DiscountPrice)

KeywordUtil.logInfo(DiscountPrice1)

TotalPrice = WebUI.getText(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/TotalPrice_opc'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/DemoObjects/checkoutpage/Page_/button_Finalizar compra'), 0)
