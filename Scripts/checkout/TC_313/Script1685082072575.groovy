...
WebUI.verifyElementClickable(findTestObject('1vedant/CheckOut(CO)/BestpromotionScrolldown_option1_OPC'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('1vedant/CheckOut(CO)/BestpromotionScrolldown_option1_OPC'), FailureHandling.OPTIONAL)

promotion = WebUI.getText(findTestObject('1vedant/CheckOut(CO)/BestpromotionScrolldown_OPC'), FailureHandling.STOP_ON_FAILURE)

'error if payment option is not selected\r\n'
WebUI.verifyElementText(findTestObject('1vedant/CheckOut(CO)/BestpromotionScrolldown_OPC'), 'De contado')
