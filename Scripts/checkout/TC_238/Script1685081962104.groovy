...
WebUI.click(findTestObject('Checkout/3DotButton_Checkout'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Checkout/DeleteAddressPopup_Checkout'), FailureHandling.STOP_ON_FAILURE)
