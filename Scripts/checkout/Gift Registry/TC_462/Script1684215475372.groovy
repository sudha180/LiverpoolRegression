...
WebUI.verifyElementNotPresent(findTestObject('1vedant/CheckOut(CO)/Edit_Message_button_Event_Checkoutpage'), 0)

WebUI.click(findTestObject('1vedant/CheckOut(CO)/Edit_Message_button_Event_Checkoutpage'))

WebUI.click(findTestObject('1vedant/CheckOut(CO)/edit_event_Message_textArea_popup_checkout'))

WebUI.setText(findTestObject('1vedant/CheckOut(CO)/edit_event_Message_textArea_popup_checkout'), 'new message')

WebUI.click(findTestObject('1vedant/CheckOut(CO)/accept_text_area_OPC'), FailureHandling.STOP_ON_FAILURE)
