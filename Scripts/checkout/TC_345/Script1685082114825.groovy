...
WebUI.setText(findTestObject('1vedant/CheckOut(CO)/newCardNumber_OPC'), '374245001741999')

WebUI.verifyElementPresent(findTestObject('1vedant/CheckOut(CO)/img_alias_OPC'), 0)

'verify that image is of visa\r\n'
WebUI.verifyElementPresent(findTestObject('1vedant/CheckOut(CO)/card_img_americanExpress_OPC'), 0)
