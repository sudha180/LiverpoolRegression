...
WebUI.click(findTestObject('Checkout/SelectStateClickNCollection_Checkout'))

WebUI.click(findTestObject('Checkout/StateOptionsClickNCollection_Checkout'))

WebUI.click(findTestObject('Checkout/StateSelectionClickNCollection_Checkout'))

WebUI.click(findTestObject('Checkout/EventSelectionClickNCollection_Checkout'))

WebUI.click(findTestObject('Checkout/EventOptionSelection_Checkout'))

WebUI.click(findTestObject('Checkout/ContinueButtonClickNCollectPopup_Checkout'))

WebUI.verifyElementPresent(findTestObject('Checkout/AddressAlertMessage_Checkout'), 0)
