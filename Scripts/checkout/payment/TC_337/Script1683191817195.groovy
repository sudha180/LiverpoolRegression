...
WebUI.getText(findTestObject('1vedant/CheckOut(CO)/card3Name_OPC'))

WebUI.enhancedClick(findTestObject('1vedant/CheckOut(CO)/card3_Option_OPC'))

'to delete card \r\n'
WebUI.verifyElementPresent(findTestObject('1vedant/CheckOut(CO)/option3DropDown_eliminor_card_OPC'), 0)

'to set card as default card\r\n'
WebUI.click(findTestObject('1vedant/CheckOut(CO)/option1DropDown_setDefault_card_OPC'))

WebUI.verifyElementClickable(findTestObject('1vedant/CheckOut(CO)/accept_deletion_card_OPC'))
