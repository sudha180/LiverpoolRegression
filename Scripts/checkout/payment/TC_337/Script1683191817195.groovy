...
'to delete card \r\n'
WebUI.click(findTestObject('1vedant/CheckOut(CO)/option3DropDown_eliminor_card_CO1'))

'to set card as default card\r\n'
WebUI.click(findTestObject('1vedant/CheckOut(CO)/option1DropDown_setDefault_card_CO1'))
