...
def PaymentTitleCSS = WebUI.getCSSValue(findTestObject('1vedant/CheckOut(CO)/paymentMethod_title_CO1'), 'font-weight')
...
WebUI.verifyElementPresent(findTestObject('1vedant/CheckOut(CO)/predefinedPayment_CO1'), 0)
