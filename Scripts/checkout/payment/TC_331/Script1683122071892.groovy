...
WebUI.verifyElementPresent(findTestObject('1vedant/CheckOut(CO)/pre_used_Adress_CardAdd_cardpopup_CO1'), 0)

'check that their is option to select for address for card is clickable\r\n'
WebUI.verifyElementClickable(findTestObject('1vedant/CheckOut(CO)/pre_used_Adress_CardAdd_cardpopup_CO1'), FailureHandling.STOP_ON_FAILURE)
