...
WebUI.click(findTestObject('Checkout/ResultGiftTable_Checkout'))
...
WebUI.setText(findTestObject('Checkout/InputTextAreaGiftTable_Checkout'), 'Testing')
...
WebUI.verifyElementPresent(findTestObject('Checkout/ChangeAddress_Checkout'), 0)
