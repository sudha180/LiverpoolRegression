...
WebUI.click(findTestObject('1vedant/CheckOut(CO)/aceptar'))

WebUI.navigateToUrl(GlobalVariable.URL2)

WebUI.click(findTestObject('1vedant/cart/home_button_(header_liverpool)'), FailureHandling.OPTIONAL)
...
WebUI.verifyElementPresent(findTestObject('1vedant/CheckOut(CO)/billingAddress_OPC'), 0)
