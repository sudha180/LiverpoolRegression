/*
 * package customkeywords import static
 ...
 * 
 * import com.kms.katalon.core.annotation.Keyword import
 * com.kms.katalon.core.checkpoint.Checkpoint import
 * com.kms.katalon.core.checkpoint.CheckpointFactory import
 * com.kms.katalon.core.mobile.keyword.MobileBuiltInKeywords import
 * com.kms.katalon.core.model.FailureHandling import
 * com.kms.katalon.core.testcase.TestCase import
 * com.kms.katalon.core.testcase.TestCaseFactory import
 * com.kms.katalon.core.testdata.TestData import
 * com.kms.katalon.core.testdata.TestDataFactory import
 * com.kms.katalon.core.testobject.ObjectRepository import
 * com.kms.katalon.core.testobject.TestObject import
 * com.kms.katalon.core.webservice.keyword.WSBuiltInKeywords import
 ...
 * 
 * import com.kms.katalon.core.testobject.RequestObject import
 * com.kms.katalon.core.testobject.ResponseObject import
 * com.kms.katalon.core.testobject.ConditionType import
 * com.kms.katalon.core.testobject.TestObjectProperty
 * 
 * import com.kms.katalon.core.mobile.helper.MobileElementCommonHelper import
 * com.kms.katalon.core.util.KeywordUtil
 * 
 * import com.kms.katalon.core.webui.exception.WebElementNotFoundException
 * import org.openqa.selenium.JavascriptExecutor; import
 * com.kms.katalon.core.webui.common.WebUiCommonHelper
 * 
 * import com.kms.katalon.core.webui.driver.DriverFactory import
 ...
 * 
 * try { WebElement element = WebUI.findWebElement(to);
 * WebUI.scrollToElement(to, 4) for (int i = 0; i < 5; i++) {
 * 
 * JavascriptExecutor js = (JavascriptExecutor)DriverFactory.getWebDriver();
 * 
 * js.
 * executeScript("arguments[0].setAttribute('style','background: white; border: 5px solid green;');"
 * , element); } KeywordUtil.logInfo("Clicking element") element.click()
 * KeywordUtil.markPassed("Element has been clicked") } catch
 * (WebElementNotFoundException e) { KeywordUtil.markFailed("Element not found")
 * } catch (Exception e) { KeywordUtil.markFailed("Fail to click on element") }
 * }
 * 
 * //highlight and click element without scroll
 * 
 * @Keyword def clickElementWithoutScroll(TestObject to) {
 * 
 * try { WebElement element = WebUI.findWebElement(to); for (int i = 0; i < 5;
 * i++) {
 * 
 * JavascriptExecutor js = (JavascriptExecutor)DriverFactory.getWebDriver();
 * 
 ...
 * , element);
 * 
 * } KeywordUtil.logInfo("Clicking element") element.click()
 * KeywordUtil.markPassed("Element has been clicked") } catch
 * (WebElementNotFoundException e) { KeywordUtil.markFailed("Element not found")
 * } catch (Exception e) { KeywordUtil.markFailed("Fail to click on element") }
 * }
